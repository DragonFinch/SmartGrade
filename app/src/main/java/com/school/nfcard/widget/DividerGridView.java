package com.school.nfcard.widget;
 ...
 * 此类的作用：GridView 分割线
 * <p>
 * Created by Liu on 2017/12/17.
 */

public class DividerGridView extends RecyclerView.ItemDecoration {
    private Paint mPaint;
    private int mDividerWidth;

    public DividerGridView(int dimensionId, int colorId) {
        mDividerWidth = (int) ResUtils.Companion.getDimension(dimensionId);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(ResUtils.Companion.getColor(colorId));
